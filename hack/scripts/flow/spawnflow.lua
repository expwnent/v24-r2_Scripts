...
if args.help then -- Help declaration
 print([[flow/spawnflow.lua
  Spawns flows with more options than built-in function
  arguments:
   -help
   ...
   -number #
     ...
     DEFAULT 1
  examples:
   flow/spawnflow -unit \\UNIT_ID -flow firebreath -size 25 -radius 10 -number 2
   flow/spawnflow -unit \\UNIT_ID -flow web -inorganic STEEL -size 10 -radius 0 -number 1
 ]])
 return
end
