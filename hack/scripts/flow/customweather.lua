...
function weather(stype,number,itype,strength,frequency,duration)
  local i
 ...
 print([[flow/customweather.lua
  ...
  arguments:
   ...
   -number #
     ...
     DEFAULT 1
  examples:
   flow/customweather -flow firebreath -size 25 -frequency 200 -number 50 -dur 7200
   flow/customweather -flow web -inorganic GOLD -size 50 -frequency 500 -number 100 -dur 1000
 ]])
 return
end
...
weather(stype,number,itype,strength,frequency,duration)
