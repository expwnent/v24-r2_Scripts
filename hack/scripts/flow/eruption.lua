 ...
 print([[flow/spawnliquid.lua
  ...
  arguments:
   ...
   -offset #,#,#
     ...
     DEFAULT 0,0,0
  examples:
   flow/spawnliquid -unit \\UNIT_ID -magma -radius 5,5,0 -depth 7 -offset 0,0,0
   flow/spawnliquid -location [\\LOCATION] -radius 1,1,1 -depth 4 -offset 5,0,0
 ]])
 return
end
